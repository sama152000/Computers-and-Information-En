...
export class SectorsService {
  ...
  private sectors: Sector[] = [
    {
      ...
      description: 'The Information Systems Department serves as the cornerstone of digital transformation, automation, data science, knowledge engineering, decision support systems, institutional management platforms, and a wide range of applied information systems across diverse sectors.',
    ...
    },
    {
      ...
      description: 'The department focuses on networking, cybersecurity, web and mobile application development, IoT, cloud computing, and IT infrastructure management.',
      headOfDepartment: {
        name: 'Dr. Hosny Ahmed Abbas',
        position: 'Coordinator of Information Technology Department',
        email: 'Hosny.abbas@fci.luxor.edu.eg'
      },
      vision: 'To foster continuous improvement in IT education, enhance institutional performance, elevate graduates to global standards of excellence, and maximize community service and sustainable development.',
      mission: 'Graduating highly skilled professionals in information technology, keeping programs up-to-date with global advancements, and solving real-world community problems through distinguished curricula and high-quality research.',
      objectives: [
      ...
      staff: [
        { name: 'Dr. Hosny Ahmed Abbas', position: 'Coordinator', email: 'Hosny.abbas@fci.luxor.edu.eg' },
        { name: 'Dr. Hammam Mohamed Mohamed', position: 'Lecturer', email: 'hammam_abdelaal@fci.luxor.edu.eg' },
        { name: 'Eng. Ibrahim Elsayed Ibrahim', position: 'Assistant Lecturer', email: 'Ibrahim.elsayed@fci.luxor.edu.eg' }
      ],
      contactInfo: {
    ...
    },
    {
      ...
      description: 'Responsible for promoting a culture of continuous improvement in education, research, and community service in alignment with NAQAAE standards.',
      headOfDepartment: {
        name: 'Dr. Mohamed Ali Fouad',
        position: 'Director of Quality Assurance Unit'
      },
      vision: 'Achieving leadership at local and regional levels in promoting quality and continuous improvement for excellence.',
      mission: 'Embedding a culture of continuous development to prepare the faculty for accreditation and contribute to sustainable community development.',
      objectives: [
    ...
    },
    {
      ...
      description: 'Develops modern, fair, and technology-enhanced student assessment and examination systems.',
      headOfDepartment: {
        name: 'Dr. Hosny Ahmed Abbas',
        position: 'Unit Director',
        email: 'Hosny.abbas@fci.luxor.edu.eg'
      },
      vision: 'Continuous development of assessment systems to enhance graduate competitiveness.',
      mission: 'Transform evaluation into a collaborative, fair, and impactful process aligned with quality standards.',
      objectives: [
  ...
  private sectorSections: SectorSection[] = [
    ...
    { id: 'research', title: 'Research Areas', icon: 'pi pi-flask', route: 'research' },
    { id: 'programs', title: 'Programs', icon: 'pi pi-graduation-cap', route: 'programs' },
