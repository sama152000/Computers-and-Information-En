...
export class ProgramsService {
  private programs: any[] = [
    {
      ...
      description:
        'The main and oldest program of the faculty, providing comprehensive education in theoretical and applied computer science, algorithms, software development, and advanced systems.',
      vision:
        'Leadership in computer science education and scientific research in Upper Egypt.',
      mission:
        'Graduating distinguished competencies capable of innovation and competing globally in software industry and scientific research.',
      objectives: [
    ...
    },
    {
      ...
      description:
        'A modern program launched in 2024 focusing on artificial intelligence, machine learning, deep learning, computer vision, and natural language processing.',
      vision:
        'To be a pioneer in AI education in Upper Egypt and a center for applied AI research.',
      mission:
        'Graduating AI specialists capable of developing intelligent systems that solve real-world problems in health, education, agriculture, and industry.',
      objectives: [
    ...
    },
    {
      ...
      description:
        'Focuses on designing and developing enterprise information systems, business analysis, database management, and digital transformation solutions.',
      vision:
        'Excellence in preparing specialists in information systems and business technology.',
      mission:
        'Graduating professionals capable of analyzing requirements and building integrated information systems that support institutional decision-making.',
      objectives: [
    ...
    },
    {
      ...
      accreditation: 'Accredited',
      description:
        'Specialized in networks, cybersecurity, cloud computing, Internet of Things (IoT), and IT infrastructure management.',
      vision:
        'Leadership in information technology and cybersecurity education.',
      mission:
        'Preparing professionals capable of designing, implementing, and securing modern information technology infrastructures.',
      objectives: [
  ...
  getProgramsForHome(): Observable<any[]> {
    const homePrograms: any[] = this.programs.map((p) => ({
      id: p.id,
      name: p.name,
  ...
  getProgramSections(): Observable<any[]> {
