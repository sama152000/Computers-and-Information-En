...
export class DepartmentsService {
  private departments: any[] = [
    {
      ...
      description:
        'The Information Systems Department serves as the cornerstone of digital transformation, automation, data science, knowledge engineering, decision support systems, institutional management platforms, and a wide range of applied information systems across diverse sectors. This role stems from its deep focus on the foundational principles of information systems—analysis, design, development, and continuous enhancement—alongside advanced database technologies, data mining, knowledge discovery, and information center management.',
      vision:
      ...
      researchGrants: [
        {
          year: 2023,
          title:
            'Permissioned Blockchain for Secure Data Sharing in Smart Cities',
          principalInvestigator: 'Dr. Hosny Ahmed Abbas',
          status: 'ongoing',
          description:
            'A research team from the department, led by Dr. Hosny Ahmed Abbas (Principal Investigator), secured funding for this project. The project is currently underway.',
        },
        {
          year: 2022,
          ...
          status: 'completed',
          description:
            'A senior student graduation project that won 2nd Place at the Upper Egypt in Action – 6th IEEE Conference in Aswan (May 12–14, 2022).',
        },
      ],
      contactInfo: {
    ...
    },
    {
      ...
      description:
        'The Computer Science Department focuses on theoretical foundations and practical applications of computing, including algorithms, programming languages, software engineering, artificial intelligence, and computational theory.',
      vision:
        'To be a leading department in computer science education and research, producing graduates who can contribute to technological advancement and innovation.',
      mission:
        'To provide comprehensive education in computer science fundamentals while fostering research and innovation in emerging technologies.',
      objectives: [
  ...
  private departmentSections: any[] = [
    {
      id: 'about',
  ...
  getDepartmentById(id: string): Observable<any | undefined> {
    const department = this.departments.find((dept) => dept.id === id);
    return of(department);
  }

  getDepartmentSections(): Observable<any[]> {
    return of(this.departmentSections);
  }

  getSectionById(sectionId: string): Observable<any | undefined> {
