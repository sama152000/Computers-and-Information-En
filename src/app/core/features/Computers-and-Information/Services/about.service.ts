...
export class AboutService {
  private aboutData: AboutTabData = {
    ...
    visionMission: {
      vision: 'To be a pioneer in computer science education and research that contributes to sustainable technology growth and innovation, recognized locally and internationally for excellence in developing skilled professionals who drive digital transformation.',
      mission: 'To provide students with comprehensive knowledge, creativity, and ethical responsibility to innovate and lead in IT industries; to conduct cutting-edge research; and to serve as a catalyst for technological advancement in our community.'
    },
    objectives: [
      {
        id: 1,
        title: 'Academic Excellence',
        description: 'Deliver high-quality education in computer science and information technology through innovative curricula and experienced faculty.',
        icon: 'pi pi-graduation-cap'
      },
      {
        id: 2,
        title: 'Research & Innovation',
        description: 'Promote and conduct research that addresses real-world challenges and contributes to technological advancement.',
        icon: 'pi pi-search'
      },
      {
        id: 3,
        title: 'Industry Partnership',
        description: 'Foster strong partnerships with leading tech companies to ensure relevance and provide practical training opportunities.',
        icon: 'pi pi-building'
      },
      {
        id: 4,
        title: 'Student Development',
        description: 'Nurture students holistically to become well-rounded professionals with strong technical and soft skills.',
        icon: 'pi pi-users'
      },
      {
        id: 5,
        title: 'Community Engagement',
        description: 'Contribute to society through technology transfer, consulting, and training programs for the local community.',
        icon: 'pi pi-share-alt'
      },
      {
        id: 6,
        title: 'Ethical Technology',
        description: 'Instill ethical principles and social responsibility in the development and deployment of technology solutions.',
        icon: 'pi pi-shield'
      }
    ],
